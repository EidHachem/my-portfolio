...
const SideBar = () => {
  return (
    <div className="h-[100vh] w-[25vw] flex flex-col justify-around items-center text-center bg-blue text-beige fixed">
      ...
      <div>
        ...
        <Carousel
          ...
          <img
            ...
            alt="s"
          />
          <img src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" alt="s" />
        </Carousel>
      </div>
      <div>
        <p>
